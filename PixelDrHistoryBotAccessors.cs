...
{
    public class PixelDrHistoryBotAccessors
    {
        public PixelDrHistoryBotAccessors(UserState userState, ConversationState conversationState)
        {
        ...
        public static string DialogStateName { get; } = $"{nameof(PixelDrHistoryBotAccessors)}.DialogState";
        public static string UserStateName { get; } = $"{nameof(PixelDrHistoryBotAccessors)}.UserConversationState";
        ...
        public IStatePropertyAccessor<UserHistoryState> UserHistoryState { get; set; }
